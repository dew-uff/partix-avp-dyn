...
public class LocalQueryTaskStatistics implements Serializable {
	...
	synchronized public void begin() {
		...
		a_beginingTime = System.nanoTime();
		a_idle = false;
		notifyAll();
	}
	...
	synchronized public void endQueryProcessing() {
		...
		a_qryProcFinishTime = System.nanoTime();
		if (a_idle)
	...
	public void idle() {
		...
		a_initIdleInterval = System.nanoTime();
		a_idle = true;
	}

	public void notIdle() {
		//a_totalIdleTime += (System.currentTimeMillis() - a_initIdleInterval);
		a_totalIdleTime += (System.nanoTime() - a_initIdleInterval);
		a_idle = false;
	}
